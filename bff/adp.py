...
2025 preseason ADP is missing from the live FFC API; it is recovered from a
Wayback Machine snapshot of https://fantasyfootballcalculator.com/adp/ppr
(captured 2025-08-08, 12-team PPR) and cached at
data/raw/adp/ppr_2025_wayback.json in the same shape as the API payloads.
"""
